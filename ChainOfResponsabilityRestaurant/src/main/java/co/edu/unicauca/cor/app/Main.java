...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        claim = new Claim(4, "Producto equivocado", "Me enviaron el pedido que no era", TypeEnum.WRONG);
        manager.getLevelOne().attend(claim);
    
        claim = new Claim(5, "Producto dañado", "Me enviaron el pedido con el producto dañado", TypeEnum.UNCLASSIFIED);
        manager.getLevelOne().attend(claim);
    }
